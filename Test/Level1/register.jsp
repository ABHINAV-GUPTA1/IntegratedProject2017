      ...
      <div id="wrapper">
         ...
         <div id="register" class="animate form">
             <form  action="signin" autocomplete="on" method="post">
               ...
               <p> 
                  <label for="passwordConfirm" class="youpasswd" data-icon="p">Please confirm your password </label>
                  <input id="passwordConfirm" name="passwordConfirm" required="required" type="password" placeholder="Confirm Password"/>
               </p>
