module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		jshint: {
			...
			dist: {
				files: {
					src: ['/ecomm/js/ideal-image-slider.js']
				}
			},
			extensions: {
				files: {
		...
		uglify: {
			...
			dist: {
				files: {
					'/ecomm/js/ideal-image-slider.min.js': '/ecomm/js/ideal-image-slider.js'
				}
			}
		},
		...
		'string-replace': {
			version: {
				...
				files: {
					'ideal-image-slider.js': '/ecomm/js/ideal-image-slider.js',
					'ideal-image-slider.css': '/ecomm/js/ideal-image-slider.css'
				}
			}
		},
		...
		watch: {
			...
			dist: {
				files: ['/ecomm/js/ideal-image-slider.js'],
